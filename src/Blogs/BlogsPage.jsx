...
//         {/* Search Bar (Fixed Icon Padding & Alignment) */}
//         <div className="max-w-md mx-auto pt-4 relative">
//           <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none text-neutral-400 z-10">
...
//             className="w-full bg-[#141211] border border-white/10 rounded-2xl pl-12 pr-4 py-4 text-white text-sm focus:outline-none focus:border-[#FE083B] transition shadow-lg"
//           />
//         </div>
//       </div>
