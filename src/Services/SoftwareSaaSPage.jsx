  ...
  const features = [
    {
      ...
      icon: <IconCloud className="w-6 h-6 text-[#FE083B]" />
    },
    {
    ...
    },
    {
      ...
      icon: <IconCpu className="w-6 h-6 text-[#FE083B]" />
    }
  ];

  return (
    <div className="min-h-screen bg-[#0a0a0a] text-neutral-100 selection:bg-[#FE083B] selection:text-white">
      ...
      <section className="relative px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-16 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-tight">
            Scalable Enterprise Software & <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FE083B] to-rose-400">Custom SaaS Platforms</span>
          </h1>
      ...
      <section className="px-6 md:px-16 lg:px-24 xl:px-32 py-16 border-t border-white/5 bg-[#0e0e11]/50">
      ...
      <section className="px-6 md:px-16 lg:px-24 xl:px-32 py-20">
        <div className="max-w-6xl mx-auto bg-gradient-to-br from-[#141211] to-[#0e0e11] border border-white/10 rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="bg-[#0a0a0a] border border-white/10 rounded-2xl p-6 sm:p-8 flex flex-col justify-center gap-6">
